...
cd wanxiang/agentforge

# 2. Install dependencies (pyproject.toml coming in next iteration)
pip install fastapi uvicorn httpx pyyaml pytest websockets
...
- [ ] 打包：`pyproject.toml` + `pip install -e .`
